...
from tyssue.behaviors.sheet_events import (
    division,
    apoptosis,
    type1_at_shorter,
    type3,
...
def test_execute_apoptosis():
    ...
    initial_cell_event = (apoptosis, face_id, (), sheet.settings["apoptosis"])
    ...
    modified_cell_event = (apoptosis, face_id, (), sheet.settings["apoptosis"])
...
def test_execute_division():
    ...
    manager = EventManager("face")
    face_id = 1
    event = (division, face_id, (), {"growth_rate": 0.2, "critical_vol": 1.5})
