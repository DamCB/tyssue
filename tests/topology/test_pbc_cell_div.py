...
#specs['settings']['boundaries'] = {'x': [-0.1, 5.97647677969762], 'y': [-0.1, 5.97647677969762]}


## final state indep of pertubation of init state
specs['settings']['boundaries'] =  {'x': [-0.1, 8.1-0.1], 'y': [-0.1, 8.1-0.1]}
#{'x': [-0.1, 5.976311365871616], 'y': [-0.1, 5.976311365871616]}
...
#hdf5.save_datasets('planar_periodic8x8_GC_global.hf5', sheet)
