...
def test_3faces():
    ...
    assert datasets['je'].shape[0] == 18
    assert datasets['face'].shape[0] == 3
    assert datasets['jv'].shape[0] == 13
...
def test_from_3d_voronoi():
    ...
    assert datasets['jv'].shape[0] == 139
    assert datasets['je'].shape[0] == 1272
...
def test_from_2d_voronoi():
    ...
    assert datasets['jv'].shape[0] == 32
    assert datasets['je'].shape[0] == 82
